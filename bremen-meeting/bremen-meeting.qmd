...
- [Updates on the COES & OCS project]{style="color: #fff;"}
...
- Updates on the COES & OCS project
...
- OCS projection 2026
  - add wave to Latin America visualizer
...
![](https://ocscoes.github.io/presentaciones/presentaciones-ocs/primer-foro/images/horizontal.png)

## Conceptual & measurement model: vertical

![](https://ocscoes.github.io/presentaciones/presentaciones-ocs/primer-foro/images/vertical.png)

# Contents {data-background-color="#2f0202" style="text-align: right;"}

<div style="height: 100vh; display: flex; flex-direction: column; justify-content: center; align-items: flex-end; text-align: right;">

- [Updates on the COES & OCS project]{style="color: #7c4848;"}
- [ELSOC Panel Visualization]{style="color: #fff;"}
- [Social Cohesion in Latin America paper]{style="color: #7c4848;"}
- [Comparative vignette study (Julio Iturra)]{style="color: #7c4848;"}
